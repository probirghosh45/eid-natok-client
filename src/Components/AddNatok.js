...
const AddNatok = () => {
  ...
  const onSubmit = (data) => {
    ...
    const natokData ={
      natokName : data.natokNameRequired,
      directorName : data.directorNameRequired,
      starring : data.StarringNameRequired,
      description : data.descriptionRequired,
      subscriptionFee : data.subscriptionFeeRequired,
      coverPhoto : data.coverPhotoRequired
    }

    console.log(natokData);

    fetch("http://localhost:4700/eid-natok", {
      method: "POST",
      body: JSON.stringify(natokData),
      headers: {
      ...
      <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
            ...
            <div>
              <label class="text-gray-700 dark:text-gray-200" for="coverPhoto">
